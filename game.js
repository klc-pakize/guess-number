...
//?localStorge topScore adiyla bir degisken olustur
let topScore = localStorage.getItem("topScore") || 0;
//?dom daki top-core degerini localStorge den okuyarak guncelle.
...
document.querySelector(".again-btn").addEventListener("click", () => {
  ...
  const body = document
    .querySelector("body")
    .classList.remove("bg-success", "bg-danger", "text-white");
  //   const body = document.querySelector("body").style.remove("write");
